'Call ExportDataToCSV("ww-historian", "NIA33391_AB3_PREDICTED_AMMONIA.F_CV", Now-1/24, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_16_DO_PVENG.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_7_DO_PVENG.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NIX33384_AB3_Z8_DO.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_8_DO_PVENG.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_16_FLOW_PVENG.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_7_FLOW_PVENG.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_8_FLOW_PVENG.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_16_VALVE_POS_PVENG.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_7_VALVE_POS_PVENG.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_8_VALVE_POS_PVENG.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NIA33391_AB3_AMMONIA.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NIR33391_AB3_Z3_NITRATE.F_CV", Now-3.04, Now)
'Call ExportDataToCSV("ww-historian", "WWSCADA2.NIR33391A_AB3_Z3_NITRITE.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NIR33392_AB3_Z9_NITRATE.F_CV", Now-3.04, Now)
'Call ExportDataToCSV("ww-historian", "WWSCADA2.NP4232_CA.F_CV", Now-3.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NR4242.F_CV", Now-3.04, Now)
